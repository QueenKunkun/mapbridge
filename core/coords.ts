...
const MC2LL = [
  ...
  [
    2.890871144776878e-9, 0.000008983055095805407, -0.00000003068298, 7.47137025468032,
...
export function fromWgs84(point: LngLat, crs: Exclude<Crs, 'amap_pixel'>): LngLat {
  switch (crs) {
    case 'wgs84':
      return point;
    case 'gcj02':
