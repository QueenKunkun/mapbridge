...
- **Portable export**: export POI favorites as MapBridge JSON, GPX 1.1, or KML 2.2; Routes can also be exported as GPX routes or KML line strings. These standard formats may lose some MapBridge fields, so use MapBridge JSON for lossless recovery.
